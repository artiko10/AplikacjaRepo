  ...
  <div class="container">
    ...
    <div class="col-sm-7"><div class="p-5 border rounded bg-success tasks text-light">
      ...
      <h5 class="text-light my-5">1. Check the percentage range for the grade</h5>
          ...
          <Form.Range id="SliderFirstHalf" type='range' min='0' max="50" step="1" value={begining} onChange={(e)=>setbegin(e.target.value)}/>
            <h5 id="FirstHalfData">from: {begining}</h5>
            <Form.Range id="SliderSecondHalf" type='range' min='51' max="100" step="1" value={ending} onChange={(e)=>setending(e.target.value)}/>
